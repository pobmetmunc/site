...
let committeeCountryLists = {
  ...
  "Supreme Court":["Chief Justice John Roberts", "Justice Clarence Thomas", "Justice Samuel Alito", "Justice Neil Gorsuch", "Justice Brett Kavanaugh", "Justice Amy Coney Barret", "Justice Anthony Kennedy", "Justice Antonin Scalia", "Justice Roger Taney", "Justice Ketanji Brown Jackson", "Justice Sonia Sotomayor", "Justice Elena Kagan", "Justice Ruth Bader Ginsburg", "Justice Thurgood Marshall", "Justice Earl Warren"],
  "UNEP":["India", "China", "Bangladesh", "United States of America", "Vietnam", "Indonesia", "South Korea", "Canada", "Mexico", "Mongolia", "Botswana", "Pakistan", "Brunei", "Cambodia", "France", "Malaysia", "Myanmar", "Philippines", "Singapore", "Thailand", "Jordan", "Saudi Arabia", "Qatar", "Spain", "Kuwait", "Germany", "Laos", "Kyrgyzstan"],
